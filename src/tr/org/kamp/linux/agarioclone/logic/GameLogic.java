...
import tr.org.kamp.linux.view.GameFrame;
import tr.org.kamp.linux.view.GamePanel;

/**
 * 
 * All game mechanics,controls are became created in this class,and acts like a
 * @author gkhan
 * @version 1.0
 * 
 *
...
public class GameLogic  {
	...
	public GameLogic(String playerName, Color selectedColor, Difficulty difficulty) {
		...
		/**
		 *Game difficulty options ,Is selected from the panel created in the windowbuild package.
		 *
		 */
		switch (difficulty) {
		case EASY:
	...
	/**
	 * 
	 * Player will be formed by contain with feed mine or monster
	 * 
	 * 
	 */
	...
	/**
	 * Movement of the mouse allows movement on the player screen.
	 * 
	 */
